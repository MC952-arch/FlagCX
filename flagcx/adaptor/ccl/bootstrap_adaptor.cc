...
flagcxResult_t bootstrapAdaptorGetStagedBuffer(void **buff, int size,
                                               int isRecv,
...
struct flagcxCCLAdaptor bootstrapAdaptor = {
    ...
    bootstrapAdaptorGetStagedBuffer, bootstrapAdaptorGetErrorString,
    bootstrapAdaptorGetLastError,
