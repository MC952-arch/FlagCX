...
The build script uses upstream base images from `harbor.baai.ac.cn/flagos-base/`:
- NVIDIA: `flagos-base-nvidia-cuda12.8:<version>`
...
- `BASE_IMAGE` - Upstream base image (e.g., `flagos-base-nvidia-cuda12.8`, `flagos-base-metax-maca3.8.1.3`)
